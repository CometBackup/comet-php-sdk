...
class ReplicaServer {
	 ...
	 *
	 * @see ReplicaServer::RemoveUnknownProperties() Remove all unknown properties
	 * @var array
	 */
	private $__unknown_properties = [];

	/**
	 * Replace the content of this ReplicaServer object from a PHP \stdClass.
	...
	/**
	 * Coerce a stdClass into a new strongly-typed ReplicaServer object.
	 *
	 * @param \stdClass $sc Object data as stdClass
	 * @return ReplicaServer
	 */
	public static function createFromStdclass(\stdClass $sc): \Comet\ReplicaServer
	{
		$retn = new ReplicaServer();
		$retn->inflateFrom($sc);
		return $retn;
	}

	/**
	 * Coerce a plain PHP array into a new strongly-typed ReplicaServer object.
	 ...
	 * @return ReplicaServer
	 */
	public static function createFromArray(array $arr): \Comet\ReplicaServer
	{
	 ...
	 * @return ReplicaServer
	 */
	public static function createFrom(array $arr): \Comet\ReplicaServer
	{
		return self::createFromArray($arr);
	}

	/**
	 * Coerce a JSON string into a new strongly-typed ReplicaServer object.
	 *
	 * @param string $JsonString Object data as JSON string
	 * @return ReplicaServer
	 */
	public static function createFromJSON(string $JsonString): \Comet\ReplicaServer
	{
	...
	/**
	 * Convert this ReplicaServer object into a plain PHP array.
	 *
