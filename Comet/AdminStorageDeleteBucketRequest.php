...
/**
 * Comet Server AdminStorageDeleteBucket API
 * Delete a bucket
 ...
 */
class AdminStorageDeleteBucketRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminStorageDeleteBucketRequest instance.
	 *
	 * @param string $BucketID Selected bucket name
	 */
	public function __construct(string $BucketID)
	{
