...
class AdminMetaSoftwareUpdateNewsRequest implements \Comet\NetworkRequest {
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\SoftwareUpdateNewsResponse
	{
		...
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\SoftwareUpdateNewsResponse::createFromStdclass(new \stdClass());
		} else {
