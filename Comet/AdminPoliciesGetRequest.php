...
/**
 * Comet Server AdminPoliciesGet API
 ...
 */
class AdminPoliciesGetRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminPoliciesGetRequest instance.
	 *
	...
	{
		return '/api/v1/admin/policies/get';
	}
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\GetGroupPolicyResponse
	{
		...
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\GetGroupPolicyResponse::createFromStdclass(new \stdClass());
		} else {
