...
/**
 * Comet Server AdminAccountValidateTotp API
 * Validate the TOTP code before turning 2fa(TOTP) on
 *
 * You must supply administrator authentication credentials to use this API.
 */
class AdminAccountValidateTotpRequest implements \Comet\NetworkRequest {
	 ...
	 * @var string
	 */
	protected $TOTPCode = null;

	/**
	 * Construct a new AdminAccountValidateTotpRequest instance.
	 *
