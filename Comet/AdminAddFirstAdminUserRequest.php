...
/**
 * Comet Server AdminAddFirstAdminUser API
 * Add first admin user account on new server
 */
class AdminAddFirstAdminUserRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminAddFirstAdminUserRequest instance.
	 *
	 * @param string $TargetUser the username for this new admin
	 * @param string $TargetPassword the password for this new admin user
	 */
	public function __construct(string $TargetUser, string $TargetPassword)
	{
	...
	{
		return '/api/v1/admin/add-first-admin-user';
	}
