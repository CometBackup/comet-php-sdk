...
/**
 * Comet Server AdminInstallationDispatchDropConnection API
 ...
 */
class AdminInstallationDispatchDropConnectionRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminInstallationDispatchDropConnectionRequest instance.
	 *
	...
	{
		return '/api/v1/admin/installation/dispatch/drop-connection';
	}
