...
/**
 * Comet Server AdminBrandingGenerateClientLinuxDeb API
 ...
 */
class AdminBrandingGenerateClientLinuxDebRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminBrandingGenerateClientLinuxDebRequest instance.
	 *
	...
	{
		return '/api/v1/admin/branding/generate-client/linux-deb';
	}
