...
/**
 * Comet Server AdminUserGroupsList API
 ...
 */
class AdminUserGroupsListRequest implements \Comet\NetworkRequest {

	/**
	 * If present, list the user groups belonging to another organization. Only allowed for administrator accounts in the top-level organization. (optional)
	 *
	 * @var string|null
	 */
	...
	/**
	 * Construct a new AdminUserGroupsListRequest instance.
	 *
	...
	{
		return '/api/v1/admin/user-groups/list';
	}
