...
/**
 * Comet Server UserWebSessionRevoke API
 ...
 */
class UserWebSessionRevokeRequest implements \Comet\NetworkRequest {

	/**
	 * Construct a new UserWebSessionRevokeRequest instance.
	 *
	 */
