...
/**
 * Comet Server AdminUserGroupsDelete API
 * Delete an existing user group object
 *
 * You must supply administrator authentication credentials to use this API.
 * This API requires the Auth Role to be enabled.
 */
class AdminUserGroupsDeleteRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminUserGroupsDeleteRequest instance.
	 *
	...
	{
		return '/api/v1/admin/user-groups/delete';
	}
