...
/**
 * Comet Server AdminAccountSessionUpgrade API
 * Upgrade a session key which is pending an MFA upgrade to a full session key
 *
 * You must supply administrator authentication credentials to use this API.
 */
class AdminAccountSessionUpgradeRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminAccountSessionUpgradeRequest instance.
	 *
	...
	{
		return '/api/v1/admin/account/session-upgrade';
	}
	...
	{
		$ret = [];
		$ret["SessionKey"] = (string)($this->SessionKey);
		return $ret;
	}
