...
/**
 * Comet Server AdminDispatcherTestSmbAuth API
 * Test a set of Windows SMB credentials
 *
 * You must supply administrator authentication credentials to use this API.
 * This API requires the Auth Role to be enabled.
 */
class AdminDispatcherTestSmbAuthRequest implements \Comet\NetworkRequest {
	 ...
	 *
	 * @var \Comet\WinSMBAuth
	 */
	protected $Wsa = null;

	/**
	 * Construct a new AdminDispatcherTestSmbAuthRequest instance.
	 *
	 * @param string $TargetID The live connection GUID
	 * @param \Comet\WinSMBAuth $Wsa The target credentials to test
	 */
	public function __construct(string $TargetID, \Comet\WinSMBAuth $Wsa)
	{
	...
	{
		return '/api/v1/admin/dispatcher/test-smb-auth';
	}
