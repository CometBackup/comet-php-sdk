...
/**
 * Comet Server AdminDisableUserTotp API
 * Disable user account 2FA(TOTP) authentication
 *
 * You must supply administrator authentication credentials to use this API.
 * This API requires the Auth Role to be enabled.
 */
class AdminDisableUserTotpRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDisableUserTotpRequest instance.
	 *
	...
	{
		return '/api/v1/admin/disable-user-totp';
	}
