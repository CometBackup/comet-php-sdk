...
class U2FRegisterRequest {
	...
	/**
	 * Replace the content of this U2FRegisterRequest object from a PHP \stdClass.
	...
	protected function inflateFrom(\stdClass $sc)
	{
		if (property_exists($sc, 'Challenge')) {
			$this->Challenge = (string)($sc->Challenge);
		}
	...
	/**
	 * Coerce a stdClass into a new strongly-typed U2FRegisterRequest object.
	 *
	 * @param \stdClass $sc Object data as stdClass
