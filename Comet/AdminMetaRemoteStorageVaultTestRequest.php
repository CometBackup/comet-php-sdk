...
/**
 * Comet Server AdminMetaRemoteStorageVaultTest API
 * Test the connection to the storage template
 *
 * You must supply administrator authentication credentials to use this API.
 * Access to this API may be prevented on a per-administrator basis.
 */
class AdminMetaRemoteStorageVaultTestRequest implements \Comet\NetworkRequest {

	/**
	 * Storage Template Vault Options
	 *
	...
	/**
	 * Construct a new AdminMetaRemoteStorageVaultTestRequest instance.
	 *
	 * @param \Comet\RemoteStorageOption $TemplateOptions Storage Template Vault Options
	 */
	public function __construct(\Comet\RemoteStorageOption $TemplateOptions)
	{
	...
	{
		return '/api/v1/admin/meta/remote-storage-vault/test';
	}
	...
	{
		$ret = [];
		$ret["TemplateOptions"] = $this->TemplateOptions->toJSON();
		return $ret;
	}
