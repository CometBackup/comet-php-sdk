...
/**
 * Comet Server AdminBrandingGenerateClientMacosArm64 API
 ...
 */
class AdminBrandingGenerateClientMacosArm64Request implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminBrandingGenerateClientMacosArm64Request instance.
	 *
	...
	{
		return '/api/v1/admin/branding/generate-client/macos-arm64';
	}
