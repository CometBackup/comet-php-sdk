...
/**
 * Comet Server AdminUserGroupsSet API
 * Update an existing user group or create a new user group
 *
 * You must supply administrator authentication credentials to use this API.
 * This API requires the Auth Role to be enabled.
 */
class AdminUserGroupsSetRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminUserGroupsSetRequest instance.
	 *
	 * @param string $GroupID The user group ID to update or create
	 * @param \Comet\UserGroup $Group The user group data
	 */
	public function __construct(string $GroupID, \Comet\UserGroup $Group)
	{
	...
	{
		return '/api/v1/admin/user-groups/set';
	}
