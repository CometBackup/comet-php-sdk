...
/**
 * Comet Server AdminDispatcherRequestBrowseVmwareDatastores API
 ...
 */
class AdminDispatcherRequestBrowseVmwareDatastoresRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDispatcherRequestBrowseVmwareDatastoresRequest instance.
	 *
	...
	{
		return '/api/v1/admin/dispatcher/request-browse-vmware/datastores';
	}
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\BrowseVMwareDatastoresResponse
	{
		...
		// Parse as BrowseVMwareDatastoresResponse
		if (is_array($decoded) && count($decoded) === 0) {
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\BrowseVMwareDatastoresResponse::createFromStdclass(new \stdClass());
		} else {
			$ret = \Comet\BrowseVMwareDatastoresResponse::createFromStdclass($decoded);
		}
