...
class WinSMBAuth {
	 ...
	 * @return WinSMBAuth
	 */
	public static function createFromStdclass(\stdClass $sc): \Comet\WinSMBAuth
	{
		$retn = new WinSMBAuth();
		$retn->inflateFrom($sc);
		return $retn;
	 ...
	 * @return WinSMBAuth
	 */
	public static function createFromArray(array $arr): \Comet\WinSMBAuth
	{
	 ...
	 * @return WinSMBAuth
	 */
	public static function createFrom(array $arr): \Comet\WinSMBAuth
	{
	 ...
	 * @return WinSMBAuth
	 */
	public static function createFromJSON(string $JsonString): \Comet\WinSMBAuth
	{
