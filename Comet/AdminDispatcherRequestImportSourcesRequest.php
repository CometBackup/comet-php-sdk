...
class AdminDispatcherRequestImportSourcesRequest implements \Comet\NetworkRequest {
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\DispatcherAdminSourcesResponse
	{
		...
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\DispatcherAdminSourcesResponse::createFromStdclass(new \stdClass());
		} else {
