...
/** 
 * Comet Server AdminDispatcherDeepverifyStorageVault API 
 ...
 */
class AdminDispatcherDeepverifyStorageVaultRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDispatcherDeepverifyStorageVaultRequest instance.
	 *
