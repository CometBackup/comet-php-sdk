...
class RegistrationLobbyConnection {
	 ...
	 *
	 * @see RegistrationLobbyConnection::RemoveUnknownProperties() Remove all unknown properties
	 * @var array
	 */
	private $__unknown_properties = [];

	/**
	 * Replace the content of this RegistrationLobbyConnection object from a PHP \stdClass.
	...
	/**
	 * Coerce a stdClass into a new strongly-typed RegistrationLobbyConnection object.
	 *
	 * @param \stdClass $sc Object data as stdClass
	 * @return RegistrationLobbyConnection
	 */
	public static function createFromStdclass(\stdClass $sc): \Comet\RegistrationLobbyConnection
	{
		$retn = new RegistrationLobbyConnection();
		$retn->inflateFrom($sc);
		return $retn;
	}

	/**
	 * Coerce a plain PHP array into a new strongly-typed RegistrationLobbyConnection object.
	 ...
	 * @return RegistrationLobbyConnection
	 */
	public static function createFromArray(array $arr): \Comet\RegistrationLobbyConnection
	{
	...
	/**
	 * Coerce a JSON string into a new strongly-typed RegistrationLobbyConnection object.
	 *
	 * @param string $JsonString Object data as JSON string
	 * @return RegistrationLobbyConnection
	 */
	public static function createFromJSON(string $JsonString): \Comet\RegistrationLobbyConnection
	{
	...
	/**
	 * Convert this RegistrationLobbyConnection object into a plain PHP array.
	 *
