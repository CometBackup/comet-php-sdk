...
class DestinationConfig {
	...
	protected function inflateFrom(\stdClass $sc)
	{
		...
		if (property_exists($sc, 'EncryptedEncryptionKey')) {
			$this->EncryptedEncryptionKey = (string)($sc->EncryptedEncryptionKey);
		}
		if (property_exists($sc, 'RepoInitTimestamp')) {
			$this->RepoInitTimestamp = (int)($sc->RepoInitTimestamp);
		}
	 ...
	 */
	public static function createFromStdclass(\stdClass $sc): \Comet\DestinationConfig
	{
	 ...
	 * @return DestinationConfig
	 */
	public static function createFromArray(array $arr): \Comet\DestinationConfig
	{
	 ...
	 * @return DestinationConfig
	 */
	public static function createFrom(array $arr): \Comet\DestinationConfig
	{
	 ...
	 * @return DestinationConfig
	 */
	public static function createFromJSON(string $JsonString): \Comet\DestinationConfig
	{
