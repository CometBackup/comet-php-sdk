...
/**
 * Comet Server AdminDispatcherRegisterOfficeApplicationCheck API
 ...
 */
class AdminDispatcherRegisterOfficeApplicationCheckRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDispatcherRegisterOfficeApplicationCheckRequest instance.
	 *
	...
	public function Parameters(): array
	{
		...
		$ret["Continuation"] = (string)($this->Continuation);
		return $ret;
	}
	...
	public static function ProcessResponse(int $responseCode, string $body): \Comet\RegisterOfficeApplicationCheckResponse
	{
		...
		// Parse as RegisterOfficeApplicationCheckResponse
		if (is_array($decoded) && count($decoded) === 0) {
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\RegisterOfficeApplicationCheckResponse::createFromStdclass(new \stdClass());
		} else {
			$ret = \Comet\RegisterOfficeApplicationCheckResponse::createFromStdclass($decoded);
		}
