...
class AdminAccountPropertiesRequest implements \Comet\NetworkRequest {
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\AdminAccountPropertiesResponse
	{
		...
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\AdminAccountPropertiesResponse::createFromStdclass(new \stdClass());
		} else {
