...
/** 
 * Comet Server AdminMetaBuildConfigSet API 
 * Set Build Role configuration
 * 
 * You must supply administrator authentication credentials to use this API.
 * Access to this API may be prevented on a per-administrator basis.
 */
class AdminMetaBuildConfigSetRequest implements \Comet\NetworkRequest {
	 ...
	 */
	protected $SoftwareBuildRoleConfig = null;
	
	/**
	 * Construct a new AdminMetaBuildConfigSetRequest instance.
	 *
