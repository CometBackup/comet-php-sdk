...
/** 
 * Comet Server AdminDispatcherRefetchProfile API 
 ...
 */
class AdminDispatcherRefetchProfileRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDispatcherRefetchProfileRequest instance.
	 *
