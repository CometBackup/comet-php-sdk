...
/**
 * Comet Server AdminConstellationStatus API
...
class AdminConstellationStatusRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminConstellationStatusRequest instance.
	 *
	 */
	...
	{
		return '/api/v1/admin/constellation/status';
	}
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\ConstellationStatusAPIResponse
	{
		...
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\ConstellationStatusAPIResponse::createFromStdclass(new \stdClass());
		} else {
