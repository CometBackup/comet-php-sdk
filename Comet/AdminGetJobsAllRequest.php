...
/** 
 * Comet Server AdminGetJobsAll API 
 * Get jobs (All)
 ...
 */
class AdminGetJobsAllRequest implements \Comet\NetworkRequest {
	
	/**
	 * Construct a new AdminGetJobsAllRequest instance.
	 *
	 */
	...
	{
		return '/api/v1/admin/get-jobs-all';
	}
