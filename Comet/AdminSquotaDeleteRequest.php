...
/**
 * Comet Server AdminSquotaDelete API
 * Delete a shared storage quota and detach all users
 *
 * You must supply administrator authentication credentials to use this API.
 * This API requires the Auth Role to be enabled.
 */
class AdminSquotaDeleteRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminSquotaDeleteRequest instance.
	 *
	...
	{
		return '/api/v1/admin/squota/delete';
	}
