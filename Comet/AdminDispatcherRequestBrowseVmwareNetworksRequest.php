...
/**
 * Comet Server AdminDispatcherRequestBrowseVmwareNetworks API
 ...
 */
class AdminDispatcherRequestBrowseVmwareNetworksRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDispatcherRequestBrowseVmwareNetworksRequest instance.
	 *
	...
	{
		return '/api/v1/admin/dispatcher/request-browse-vmware/networks';
	}
	 ...
	 * @throws \Exception
	 */
	public static function ProcessResponse(int $responseCode, string $body): \Comet\BrowseVMwareNetworksResponse
	{
		...
		// Parse as BrowseVMwareNetworksResponse
		if (is_array($decoded) && count($decoded) === 0) {
		// Work around edge case in json_decode--json_encode stdClass conversion
			$ret = \Comet\BrowseVMwareNetworksResponse::createFromStdclass(new \stdClass());
		} else {
			$ret = \Comet\BrowseVMwareNetworksResponse::createFromStdclass($decoded);
		}
