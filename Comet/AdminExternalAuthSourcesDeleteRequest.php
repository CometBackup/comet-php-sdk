...
/**
 * Comet Server AdminExternalAuthSourcesDelete API
 * Delete an external admin authentication source
 *
 * You must supply administrator authentication credentials to use this API.
 */
class AdminExternalAuthSourcesDeleteRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminExternalAuthSourcesDeleteRequest instance.
	 *
	...
	{
		return '/api/v1/admin/external-auth-sources/delete';
	}
