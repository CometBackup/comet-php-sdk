...
/** 
 * Comet Server AdminDispatcherReindexStorageVault API 
 ...
 */
class AdminDispatcherReindexStorageVaultRequest implements \Comet\NetworkRequest {
	...
	/**
	 * Construct a new AdminDispatcherReindexStorageVaultRequest instance.
	 *
