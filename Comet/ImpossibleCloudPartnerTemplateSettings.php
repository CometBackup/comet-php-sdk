...
class ImpossibleCloudPartnerTemplateSettings {
	...
	/**
	 * Replace the content of this ImpossibleCloudPartnerTemplateSettings object from a PHP \stdClass.
	...
	/**
	 * Coerce a stdClass into a new strongly-typed ImpossibleCloudPartnerTemplateSettings object.
	 *
	 * @param \stdClass $sc Object data as stdClass
	 * @return ImpossibleCloudPartnerTemplateSettings
	 */
	public static function createFromStdclass(\stdClass $sc): \Comet\ImpossibleCloudPartnerTemplateSettings
	{
		$retn = new ImpossibleCloudPartnerTemplateSettings();
		$retn->inflateFrom($sc);
		return $retn;
	}

	/**
	 * Coerce a plain PHP array into a new strongly-typed ImpossibleCloudPartnerTemplateSettings object.
	 ...
	 * @return ImpossibleCloudPartnerTemplateSettings
	 */
	public static function createFromArray(array $arr): \Comet\ImpossibleCloudPartnerTemplateSettings
	{
	...
	/**
	 * Coerce a JSON string into a new strongly-typed ImpossibleCloudPartnerTemplateSettings object.
	 *
	 * @param string $JsonString Object data as JSON string
	 * @return ImpossibleCloudPartnerTemplateSettings
	 */
	public static function createFromJSON(string $JsonString): \Comet\ImpossibleCloudPartnerTemplateSettings
	{
	...
	/**
	 * Convert this ImpossibleCloudPartnerTemplateSettings object into a plain PHP array.
	 *
